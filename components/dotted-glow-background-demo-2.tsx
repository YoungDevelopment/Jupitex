  ...
  return (
    <div className="relative mx-auto flex w-full max-w-7xl items-center justify-center">
      <DottedGlowBackground
        ...
        gap={14}
        radius={2}
        colorLightVar="--color-black"
        glowColorLightVar="--color-black"
        colorDarkVar="--color-black"
        glowColorDarkVar="--color-black"
      ...
      <div className="relative z-10 flex w-full flex-col items-center justify-between space-y-6 px-8 py-16 text-center md:flex-row">
        <div>
          ...
          Get a free <span className="font-bold">AI Blueprint</span> for your business
     
          </h2>
          <p className="mt-4 max-w-lg text-center md:text-left dark:text-neutral-300">
          We&apos;ll look at how your business runs and show you exactly what&apos;s worth automating — how much time and money each change saves. No cost, no commitment.
          </p>
        </div>
